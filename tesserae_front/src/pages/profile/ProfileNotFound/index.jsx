    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 p-8">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="relative inline-block">
          ...
          {/* Question marks around cat */}
          <span className="absolute -top-4 -left-8 text-5xl text-slate-300 font-bold">?</span>
          <span className="absolute -top-2 -right-8 text-4xl text-slate-300 font-bold">?</span>
          <span className="absolute -bottom-8 left-4 text-3xl text-slate-300 font-bold">?</span>
        </div>
